        ...
        "cantrip spell scroll" to
                MagicItem(
                    ...
                    description = "\n\tA spell scroll bears the words of a single spell, " +
                            "written in a mystical cipher. If " +
                            "the spell is on your class’s spell list, you can read " +
                            "the scroll and cast its spell " +
                            "without providing any material components. Otherwise, the " +
                            "scroll is unintelligible. " +
                            "Casting the spell by reading the scroll requires the spell’s " +
                            "normal casting time. Once " +
                            "the spell is cast, the words on the scroll fade, " +
                            "and it crumbles to dust. If the " +
                            "casting is interrupted, the scroll is not lost." +
                            "\n\tThis scroll contains a cantrip. The spell's saving " +
                            "throw DC is 13 and attack bonus is +5."
                ),
        "potion of climbing" to
                MagicItem(
                    name = "Potion of Climbing",
                    description = "\n\tWhen you drink this potion, you gain a " +
                            "climbing speed equal to your walking " +
                            "speed for 1 hour. During this time, you have " +
                            "advantage on Strength (Athletics) checks " +
                            "you make to climb. The potion is separated " +
                            "into brown, silver, and gray layers " +
        ...
        "1st level spell scroll" to
                MagicItem(
                    ...
                    description = "\n\tA spell scroll bears the words of a single " +
                            ...
                            "whether you cast it successfully. The DC equals 11. " +
                            "On a failed check, the spell " +
                            "disappears from the scroll with no other effect." +
                            "\n\tThis scroll contains a 1st level spell. The " +
                            ...
                            "Intelligence (Arcana) check with a DC equal to 11. " +
                            "If the check succeeds, the spell " +
                            "is successfully copied. Whether the check succeeds " +
